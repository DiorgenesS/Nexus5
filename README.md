#Project MIUI 8 Patchrom for Google Nexus 5
...
$ git clone https://github.com/DiorgenesS/Nexus5.git nexus5

# 3.Build

$ . build/envsetup.sh && cd nexus5
